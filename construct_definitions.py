...
SECTION_TO_CONSTRUCT = {
    ...
    'general':       'demographic',
    # Protective factors
    'autoridad':     'clima_docente',       # zero_autoridad_* (SURVEY_004)
    'clima':         'clima_docente',       # zero_clima_*     (SURVEY_003)
    'normas':        'normas_grupo',        # zero_normas_*
    # Risk — traditional bullying
    'victima':       'victimizacion',       # zero_victima_*
    'victim':        'victimizacion',       # zero_victim_general edge case
    'agresor':       'perpetracion',        # zero_agresor_*
    # Risk — cyberbullying (direct sections, no parent)
    'cybervictima':  'cybervictimizacion',  # zero_cybervictima_* (SURVEY_004)
    'cyberagresor':  'cyberagresion',       # zero_cyberagresor_* (SURVEY_004)
    'cyber':         'cyberbullying',       # zero_cyber_*        (SURVEY_003, resolved by subsection)
    # Ecology
    'ecologia':      'ecologia_espacios',   # zero_ecologia_*
    # Institutional support
    'institucional': 'apoyo_institucional', # zero_institucional_* (SURVEY_004)
    'apoyo':         'apoyo_institucional', # zero_apoyo_*         (SURVEY_003)
    # Impact
    'internivel':    'impacto',             # zero_internivel_*    (SURVEY_004)
    'impacto':       'impacto',             # zero_impacto_*       (SURVEY_003)
}

# Cyber subsections → specific constructs (SURVEY_003 format only)
# SURVEY_004 uses direct sections: cybervictima / cyberagresor
...
if __name__ == '__main__':
    test_cases = [
        ...
        # Format B — SURVEY_004 real IDs from Supabase
        ('zero_general_genero_v2',                 'demographic'),
        ('zero_general_edad_v2',                   'demographic'),
        ('zero_general_tipo_escuela_v2',           'demographic'),
        # Victimización
        ...
        # Cybervictimización — sección directa SURVEY_004
        ...
        # Cyberagresión — sección directa SURVEY_004
        ('zero_cyberagresor_mensajes',             'cyberagresion'),
        ('zero_cyberagresor_exclusion',            'cyberagresion'),
        # Clima docente — sección autoridad SURVEY_004
        ('zero_autoridad_normas',                  'clima_docente'),
        ('zero_autoridad_escucha',                 'clima_docente'),
        ('zero_autoridad_interviene',              'clima_docente'),
        ('zero_autoridad_seguimiento',             'clima_docente'),
        ('zero_autoridad_accion_digital',          'clima_docente'),
        ('zero_autoridad_coordina',                'clima_docente'),
        ('zero_autoridad_bienestar',               'clima_docente'),
        # Normas de grupo
        ...
        # Apoyo institucional — sección institucional SURVEY_004
        ('zero_institucional_protege',             'apoyo_institucional'),
        ('zero_institucional_seguimiento',         'apoyo_institucional'),
        ('zero_institucional_orientador',          'apoyo_institucional'),
        ('zero_institucional_acceso_adulto',       'apoyo_institucional'),
        ('zero_institucional_protocolo',           'apoyo_institucional'),
        ('zero_institucional_sin_represalia',      'apoyo_institucional'),
        # Impacto — sección internivel SURVEY_004
        ('zero_internivel_supervision',            'impacto'),
        ('zero_internivel_norma',                  'impacto'),
        ('zero_internivel_coercion',               'impacto'),
        ('zero_internivel_intervencion',           'impacto'),
        ('zero_internivel_intimidacion',           'impacto'),
        # Ecología
        ('zero_ecologia_aula_v2',                  'ecologia_espacios'),
        ('zero_ecologia_banos',                    'ecologia_espacios'),
        ('zero_ecologia_patio_v2',                 'ecologia_espacios'),
        ('zero_ecologia_cafeteria_v2',             'ecologia_espacios'),
        ('zero_ecologia_entrada_salida_v2',        'ecologia_espacios'),
        ('zero_ecologia_transporte_v2',            'ecologia_espacios'),
    ]
